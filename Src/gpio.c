...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AO_Pin|SCL_Pin|SDA_Pin|CS_Pin
                          |INC_1_Pin|U_D_1_Pin|CS_1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin PBPin */
  GPIO_InitStruct.Pin = ALARM_Pin|AO_Pin|SCL_Pin|SDA_Pin
                          |CS_Pin|M0_IO_Pin|M1_IO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void GPIO_Reset_Init(void)
{
	...
	HAL_GPIO_DeInit(GPIOC,GPIO_PIN_13|GPIO_PIN_1|GPIO_PIN_2
